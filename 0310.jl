...
# ╔═╡ 44d2899b-f023-4f6a-9fc1-03a6179d6ea4
γᵐᵒᵐ=3333
...
# ╔═╡ d57be2ac-94a3-4aa8-ba0f-e3e21f6ca525
sttttt = 'asdf'  # 작은따옴표는 안된다. 인덱싱은 1,2,3 ... 

# ╔═╡ 270eb0df-ff94-4e75-99ad-a8ee30506d68
sttdste = "asdf"
...
# ╔═╡ cc78388e-6d11-4e60-8f20-07825dc98fff
string(str1, "dfg")
...
# ╔═╡ c085b56b-9f8e-48df-be25-215068885318
typeof((1,2,3))

# ╔═╡ 8c81c79a-4ce5-40be-9049-493067fccfec
1,2,3 # 괄호는 생략가능   # 파이썬이랑 똑같넴 
...
# ╔═╡ cfe7e4b7-4382-4b80-b316-b7411a644db6
# 파이썬의 리스트 [1,2,3]
# R에서의 c(1,2,3) 과 비슷하다. 
...
# ╔═╡ f257bb64-24d2-4423-99e2-1e4fa3efc565
b.+3
...
# ╔═╡ c9216d4b-c742-4065-a83e-836b46dc3bdf
["a",2,3,4.0] .== ["A",2,3,4]   # 4.0과 4가 ture라고 나오넹 
...
rand([1,2,3,4],2) # rand의 두번째 기능: sample  4개의 원소중 2개 뽑기 
