...
# ╔═╡ 805b4d78-d11b-45f4-9abc-912a94565d9b
md"""
ctrl+m 을 누르면 마크다운으로 바뀐다
"""
...
# ╔═╡ 52b0c8cf-4c78-409d-810e-16deb39126aa
@bind votee Radio(["코코", "쿠쿠"])

# ╔═╡ d3fb122b-af76-44bb-9704-bbfa5ea98be9
votee

# ╔═╡ d7ab92fd-1fb4-48bc-b86a-1e3cd91747d1
if votee=="코코"
	md"코코는 귀여워"
else
	md"쿠쿠는 맛있어"
...
# ╔═╡ 15d5ea0c-fc14-434e-96a2-7f67cca716ac
@bind chckbx2 CheckBox()
# 체크박스 옆에 설명글은 못나오나? ㅁ 학생 ㅁ 직장인 이렇게.. 
...
# ╔═╡ e2afa72a-bb55-45d4-bd1b-0537be42e5f0
...
#shift 누르고 다중선택, default:처음 커서 위치하는 곳
...
# ╔═╡ 9c78510e-c200-450b-b229-f3933a2310c7
# \sqrt 누르고 탭키 누르면 루트
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "4471a1caf000badcb732d56e81326cd7e014ee2d"
