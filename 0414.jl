...
let 
	...
	rand(Normal(b,a),N) |> histogram! # 위, 아래 두개의 히스토그램은 똑같다

end 

# ╔═╡ 3bf10379-5d95-4942-9ec8-ecb3fe026e24
md"""
`-` 시뮬레이션확인2 (지수분포) - 척도모수를 가짐
"""
...
# ╔═╡ 64e42dfc-905f-4ce6-8bc0-6af1707a2bd4
let 
	N = 100000 

	rand(Exponential(2),N) |> histogram
	rand(Exponential(4),N) |> histogram	
	rand(Exponential(2),N).*2 |> histogram!
end
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "8c9657f5959ccbda92637e0faeba9e5e3cb162a4"
