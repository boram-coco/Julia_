...
# ╔═╡ 43bd516c-b735-4540-9b26-c6528d07ec44
...
# ╔═╡ f56ec69d-1649-40f6-95a5-b55ea3902467
# 방법1

# ╔═╡ 2d8c38c2-90d7-4e27-877a-c5d8790ec8ea
rand(Binomial(30,0.45),100)

# ╔═╡ ecebc4e5-c1b0-44a4-a847-6e70ba9902a6
histogram(rand(Binomial(30,0.45),100))

# ╔═╡ cae7486d-ce56-4bd5-83ce-83464ed398e5
# 방법2

# ╔═╡ 7af431b4-925e-43b6-aed9-05fec4799afe
rand(Bernoulli(0.45),30)

# ╔═╡ ae8c1b01-ad06-46ed-bacc-7856608871fb
[rand(Bernoulli(0.45),30) for i in 1:100]

# ╔═╡ 7eddbd76-ca4a-478e-9512-6a472b4298ca
[rand(Bernoulli(0.45),30) for i in 1:100] .|> sum

# ╔═╡ b76c6543-1ff6-4433-8df6-309efd079d42
histogram([rand(Bernoulli(0.45),30) for i in 1:100] .|> sum)

# ╔═╡ a3bce01e-485c-4ae7-8ec3-2e679b13a72b
# 방법3

# ╔═╡ 3743ba48-eb03-4063-a98f-c7d67994a9e0
rand(30)

# ╔═╡ b0e57138-cfdd-4ba0-85db-33bb80d2db48
rand(30) .< 0.45

# ╔═╡ 7330ce47-2700-4226-8ce9-49579f1bc52c
[rand(30) .< 0.45 for i in 1:100]

# ╔═╡ f5692cae-f239-444c-b662-16e4e852a561
histogram([rand(30) .< 0.45 for i in 1:100])
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "4e8673bfe59691c9f454f3bfa32ffa0c621494e1"
