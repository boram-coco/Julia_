...
Plots.plotly() # plots의 백엔드,, 그래프에 마우스 커서를 대면 숫자가 나옴 
...
# 그림 합쳐 그리고 싶으면 plot! 뒤에 느낌표 붙여주기
...
plot(x,g_lee(x)) # 브로드캐스팅해서 바로 적용가능
...
plot(_h(1),-2,2); plot!(_h(-1),-2,2)  # , -2:0.1:2) 와 같은 것도 가능 
...
# ╔═╡ 5db48df2-0f07-4dd8-ad6a-450d0af3b951
@. sin(0:1:π)

# ╔═╡ d76bc553-7100-453d-b85a-515ee17af3b7
sin.(0:1:π)
...
n≤2 ? println("2보다작거나같음") : println("2보다큼") # if문의 축약버전
...
# ╔═╡ ee0a8088-0f60-4d3c-aec4-708414f4e1c6
plot(1:8,a)
...
# ╔═╡ 87ebbe0e-79d6-467f-86ef-efd33519ca26
hom(n) = n ≤ 1 ? 2 : hom(n-1) + 3

# ╔═╡ eef582a5-5777-4638-b92d-169e9d1a3277
scatter(1:10,hom)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "b08335ee946c736fe036bc5f25bcfb3d584aee6b"
