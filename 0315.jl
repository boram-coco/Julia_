...
# ╔═╡ 489c8372-c0b9-4056-80c3-aac737cb76b1
using Plots
...
# ╔═╡ 76abc77d-f856-44c1-8a12-e7ed6914f8c2
[ 1 2 3 ]
...
# ╔═╡ 01d33bd8-7b96-4f2f-b9f5-2f84861fd10b
[2,3,4]'
...
reshape(1:6, (6,1))  # 컬럼 벡터

# ╔═╡ e5a82661-28f9-42c1-8763-a633dd89c2db
reshape(1:6, (1,6))  # 로우 벡터
...
(1:3) + (1:3) # 2에서 시작해서 6까지, 2칸씩 띄어서. (2,4,6)
...
A= [1 2 3 		# 인덱싱 번호 1 4 7
	4 5 6 				# 	2 5 8 
	7 8 9] 				#   3 6 9

# ╔═╡ 53f20376-8a7e-402a-95f5-769242bc8627
A[4]
...
# ╔═╡ f002adb7-4595-4144-81d0-c3179f69fa89
# \circ + tab -> ∘
...
# ╔═╡ 7439ec41-cebb-4c86-92ff-4fc35287c029
ff = (x -> x^2) ∘ (x -> x-1)

# ╔═╡ fd9498d5-df28-401c-bd74-e01fdbbed568
ff(6)

# ╔═╡ a77058bf-103c-4772-b7dc-662ae15a729b
x=Array(-1:0.05:3)

# ╔═╡ 72635284-2b90-41ce-b245-bfb1b82660f3
y = [g(x) for x in -1:0.05:3]

# ╔═╡ 4cd3b7da-275c-4808-af6a-d5065d280195
plot(x,ff)
